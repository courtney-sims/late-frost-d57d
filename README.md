...
```
npm create cloudflare@latest -- --template=cloudflare/templates/late-frost-d57d
```

A live public deployment of this template is available at [https://late-frost-d57d.templates.workers.dev](https://late-frost-d57d.templates.workers.dev)
